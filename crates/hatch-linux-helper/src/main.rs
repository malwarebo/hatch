...
mod imp {
    ...
    fn libc_syscall_number(name: &str) -> Option<i64> {
        match name {
            ...
            "chroot" => Some(libc::SYS_chroot as i64),
            "swapon" => Some(libc::SYS_swapon as i64),
            "swapoff" => Some(libc::SYS_swapoff as i64),
            "reboot" => Some(libc::SYS_reboot as i64),
            "kexec_load" => Some(libc::SYS_kexec_load as i64),
            "kexec_file_load" => Some(libc::SYS_kexec_file_load as i64),
            ...
            "keyctl" => Some(libc::SYS_keyctl as i64),
            "add_key" => Some(libc::SYS_add_key as i64),
            "request_key" => Some(libc::SYS_request_key as i64),
            "unshare" => Some(libc::SYS_unshare as i64),
            "setns" => Some(libc::SYS_setns as i64),
            "clone3" => Some(libc::SYS_clone3 as i64),
            "mount_setattr" => Some(libc::SYS_mount_setattr as i64),
            "open_tree" => Some(libc::SYS_open_tree as i64),
            ...
            "execveat" => Some(libc::SYS_execveat as i64),
            "vfork" => Some(libc::SYS_vfork as i64),
            _ => None,
        }
    }
